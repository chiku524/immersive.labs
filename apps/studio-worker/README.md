...
| `STUDIO_OLLAMA_NUM_PREDICT` | `2048` | Ollama `options.num_predict` — caps output length for the JSON spec (**512–16384**); lowers risk of endless generation on weak VMs. Raise if validation fails with truncated JSON. |
